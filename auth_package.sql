-- =============================================================================
-- Oracle Package voor Authenticatie (SEV_AUTH_PKG) - Versie 1.1
-- =============================================================================
...
-- - PLS-00231 opgelost door de hash-functie niet direct in SQL aan te roepen.
--
...
CREATE OR REPLACE PACKAGE BODY SEV_AUTH_PKG AS
    ...
    BEGIN
        ...
        -- Hash het wachtwoord en sla het op in een lokale variabele
        l_password_hash := hash_password(p_password);
